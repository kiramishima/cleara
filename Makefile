...
# Database Connection
DATABASE_URL=postgresql://postgres:12356@192.168.100.7/scala_customers?sslmode=disable up
...
run_local:
	env DATABASE_URL=$(DATABASE_URL) SecretKey=$(APP_KEY) MAIL_HOST=$(MAIL_HOST) MAIL_PORT=$(MAIL_PORT) MAIL_USERNAME=$(MAIL_USERNAME) MAIL_PASSWORD=$(MAIL_PASSWORD) ./$(SERVICE_NAME)
